            ...
            try:
                ...
                if auto_remove_role:
                    embed.add_field(
                        ...
                        value=f"Getting any role will remove: {auto_remove_role.mention}",
                        inline=False
                    )
                ...
                await log_action(interaction.guild.id, "reaction_role", f"🎭 [REACTION ROLE] Multi-setup by {interaction.user} - {len(pairs)} pairs in {channel.name}")
